...
public class ComplexArray
{
    ...
    public int getLen(){
    	ComplexArray c = this;
    	return c.real.length;
    }
    
    public ComplexArray timesConj(){
    	ComplexArray a=this;
    	int len = a.getLen();
    	ComplexArray c = new ComplexArray(len);
    	for (int i=0;i<len; i++){
    		c.real[i]=(a.get(i).times(a.get(i).conj())).real;
    		c.imag[i]=(a.get(i).times(a.get(i).conj())).imag;
    	}
    	return c;
    }
}
