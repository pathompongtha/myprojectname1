...
public class LinphonePreferencesSIPAccountActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		if(intent.getBooleanExtra("e", false)) {
			Toast.makeText(getApplicationContext(), "creating telemed account", Toast.LENGTH_SHORT).show();
			addTelemedAccount(screen, n);
		} else {
			addExtraAccountPreferencesFields(screen, n);
		}
	}
	
	public void addTelemedAccount(PreferenceScreen parent, final int n) {
